...
Each child app (as beta: schedule, Pico, contact, and MagicCube) have the same look and feel, and with simple intuitive "wizard" type UI, using help tips, warnings, and errors.
